...
const CloudConnectivityStrategyPage = () => {
  ...
  return (
    <div className="p-6 max-w-lg mx-auto">
      <h1 className="text-2xl font-bold mb-6 text-center">Cloud & Connectivity Strategy</h1>
          ...
          <div className="space-y-2 mt-2">
            {cloudPlatforms.map((platform) => (
              <div key={platform.id} className="flex items-center space-x-2">
                ...
                <Label htmlFor={platform.id} className="font-normal">{platform.label}</Label>
              </div>
            ))}
          </div>
        </div>
        ...
        <div>
          ...
          <RadioGroup defaultValue="undecided-iot" className="mt-2 space-y-2">
            <div className="flex items-center space-x-2">
              ...
              <Label htmlFor="yes-iot" className="font-normal">Yes (e.g., Device Management, Fleet Management)</Label>
            </div>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="no-iot" id="no-iot" />
              <Label htmlFor="no-iot" className="font-normal">No</Label>
            </div>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="undecided-iot" id="undecided-iot" />
              <Label htmlFor="undecided-iot" className="font-normal">Undecided</Label>
            </div>
          </RadioGroup>
        </div>
